...
DIMENSIONS_BOARD = 16						# Dimensions du jeu (ex : 21 = 21x21)
...
MUTATION_RATE = 0.5							# Pourcentage de mutation à chaque création d'un noeud pour un nouveau snake (à partir de la deuxième GENERATION) 
